...
stripe.api_key = 'sk_test_2TsFJf5sZ4SyAFmIsGtjwNbv004elRdHp4'
...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        plan = 'plan_HGVDLeudpnW1j5'
        if request.POST['plan'] == 'yearly':
            plan = 'plan_HH31x73Zv0N7c6'
        if request.POST['coupon'] in coupons:
            ...
            try:
                ...
                pass
            subsription = stripe.Subscription.create(customer=stripe_customer.id,
        ...
        customer.cancal_at_period_end = False
        customer.stripe_subscription_id = subsription.id
        customer.save()
        ...
        return render(request, 'plans/checkout.html',{'plan':plan,
               'coupon':coupon, 'price':price, 'og_dollar':og_dollar, 
